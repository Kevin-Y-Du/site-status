  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> 1922222.xyz </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/Kevin-Y-Du/site-status",
  home: "https://1922222.xyz",
  email: "mailto:kevin@1922222.xyz",
};
</script>
